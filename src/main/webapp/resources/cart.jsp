		...
		<div class="xans-element- xans-order xans-order-basketpackage ">
			...
			<div class="orderListArea">
				...
				<table border="1" summary=""
					...
					<tfoot>
						<tr>
							<td colspan="10">합계 : <strong
								class="total"><span>${cost }</span>원</strong> <span
						...
						<c:forEach var="cart" items="${cartList }">
							...
							<td class="thumb"><a
								href="/product/detail.html?product_no=16&cate_no=24"><img
									...
									alt="샘플상품 8" /></a></td>
							<td class="product"><a
								href="/product/detail.html?product_no=16&cate_no=24"><strong>${cart.name}</strong> </a><span class="displaynone"><br />(영문명 : )</span></td>
							<td class="price">
								<strong>${cart.cost }원</strong>
							</td>
							<td class="mileage">-</td>
							<td class="total"><strong>${cart.cost }</strong>
					...
					<tbody>
						<tr>
							<td class="price"><div class="box">
									<strong>${cost }</strong>원 <span class="tail displaynone"></span>
								</div></td>
							<td class="total"><div class="box">
									<strong>${cost }</strong>원 <span
