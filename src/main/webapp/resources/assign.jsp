...
<script src="/resources/js/assign.js"></script>
...
<body>
	...
	<div id="contents_right">
		...
		<form id="joinForm" name="joinForm" action="/assign/"
						...
						<tbody>
							<tr>
								<th scope="row">아이디 <img
									...
									alt="필수" /></th>
								<td>
									<input id="member_id" name="userId" class="inputTypeText" value="" type="text" /> 
							...
							<tr>
								<th scope="row">비밀번호 <img
									src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif"
									alt="필수" /></th>
								<td><input id="passwd" name="userPassword"
									fw-filter="isFill&isMin[4]&isMax[16]" fw-label="비밀번호" fw-msg=""
									maxlength="16" value="" type="password" /> (영문 대소문자/숫자/특수문자 중
							...
							<tr>
								...
								<td><input id="user_passwd_confirm"
									...
									fw-label="비밀번호 확인" fw-msg="비밀번호가 일치하지 않습니다." maxlength="16"
							...
							<tr>
								<th scope="row" id="nameTitle">이름 <img
									src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif"
									alt="필수" /></th>
								<td><span id="nameContents"><input id="userName"
										name="userName" fw-filter="isFill&isMax[20]" fw-label="이름"
										fw-msg="" class="inputTypeText" maxlength="20" value=""
							...
							<tr>
								...
								<td><input id="addr2" name="address" fw-filter="" fw-label="주소" fw-msg="" class="inputTypeText" value="" type="text" /> 나머지주소</td>
							</tr>
							...
							<tr>
								<th scope="row">휴대전화 <img
									src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif"
									class="displaynone" alt="필수" /></th>
								<td><input id="addr2" name="phoneNumber" value="" type="text" /></td>
							</tr>
							<tr>
							...
							<tr class="">
								...
								<td><input id="is_news_mail0" name="is_news_mail"
									...
									type="radio" checked="checked" /><label for="is_news_mail0">수신함</label>
									<input id="is_news_mail1" name="is_news_mail"
									fw-filter="isFill" fw-label="is_news_mail" fw-msg="" value="F"
									type="radio" /><label for="is_news_mail1">수신안함</label>
						...
						<tbody>
							...
							<tr class="">
								...
								<td><input id="birth_year" name="birth_year" fw-filter=""
									fw-label="생년월일" fw-msg="" class="inputTypeText" maxlength="4"
									value="" type="text" /> 년 <input id="birth_month"
									name="birth_month" fw-filter="" fw-label="생년월일" fw-msg=""
									class="inputTypeText" maxlength="2" value="" type="text" /> 월
									<input id="birth_day" name="birth_day" fw-filter=""
									fw-label="생년월일" fw-msg="" class="inputTypeText" maxlength="2"
									value="" type="text" /> 일 <span class="birth "><input
										id="is_solar_calendar0" name="is_solar_calendar" fw-filter=""
										fw-label="생년월일" fw-msg="" value="T" type="radio"
										checked="checked" /><label for="is_solar_calendar0">양력</label>
										<input id="is_solar_calendar1" name="is_solar_calendar"
										fw-filter="" fw-label="생년월일" fw-msg="" value="F" type="radio" /><label
				...
				<div class="agreeArea">
					<div class="agree">
						...
						<p>
							...
							사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>② “이용자”란 “몰”에 접속하여 이 약관에 따라
							“몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.<br>③ ‘회원’이라 함은 “몰”에 (삭제)
						...
						<p>
							...
							제1항에 의한 개인정보 취급위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.
						</p>
						<p>
					...
					<div class="agreeArea">
						...
						<p class="check">
							<span>개인정보 제3자 제공에 동의하십니까?</span> <input
								...
								type="checkbox" /><label for="agree_information_check0">동의함</label>
						</p>
					</div>
				</div>
				<div class="displaynone">
					...
					<div class="agreeArea">
						...
						<p class="check">
							<span>개인정보 취급 위탁에 동의하십니까?</span> <input
								id="agree_consignment_check0" name="agree_consignment_check[]"
								fw-filter="" fw-label="개인정보 취급 위탁 동의" fw-msg="" value="1"
								type="checkbox" /><label for="agree_consignment_check0">동의함</label>
						</p>
					</div>
				</div>
				<div class="btnArea center">
					<a href="#none" onclick="memberJoinAction()"><img
						src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/btn_member_join1.gif"
						alt="회원가입" /></a> <a href="/index.html"><img
						src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/btn_member_join_cancel.gif"
						alt="회원가입취소" /></a>
				</div>
			</div>
		</form>
