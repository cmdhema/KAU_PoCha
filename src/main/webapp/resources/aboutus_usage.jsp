...
<html>
<head>
<link rel="stylesheet" type="text/css" href="/resources/css/aboutus_usage.css"/>
		...
		<div class="xans-element- xans-mall xans-mall-faq ">
            ...
            <li><a href="#etc">기타 안내</a></li>
				...
				<div class="wrap_title">
					<img src="/resources/img/title_guide1.gif" alt="회원가입 안내" />
				</div>
				<div class="cont">
					<h3>회원가입 안내</h3>
            ...
            <li><a href="#etc">기타 안내</a></li>
				...
				<div class="wrap_title">
					<img src="/resources/img/title_guide2.gif" alt="주문 안내" />
				</div>
				<div class="cont">
					<h3>주문 안내</h3>
            ...
            <li><a href="#etc">기타 안내</a></li>
				...
				<div class="wrap_title">
					<img src="/resources/img/title_guide3.gif" alt="결제 안내" />
				</div>
				<div class="cont">
					<h3>결제안내</h3>
            ...
            <li><a href="#etc">기타 안내</a></li>
				...
				<div class="wrap_title">
					<img src="/resources/img/title_guide4.gif" alt="배송 안내" />
				</div>
				<div class="cont">
					<h3>배송안내</h3>
					<ul>
            ...
            <li><a href="#etc">기타 안내</a></li>
				...
				<div class="wrap_title">
					<img src="/resources/img/title_guide5.gif" alt="교환/반품 안내" />
				</div>
				<div class="cont">
					<h3>교환/반품안내</h3>
            ...
            <li><a href="#etc">기타 안내</a></li>
				...
				<div class="wrap_title">
					<img src="/resources/img/title_guide6.gif" alt="환불 안내" />
				</div>
				<div class="cont">
					<h3>환불안내</h3>
            ...
            <li class="selected"><a href="#etc">기타 안내</a></li>
				...
				<div class="wrap_title">
					<img src="/resources/img/title_guide7.gif" alt="기타 안내" />
				</div>
				<div class="cont">
					<h3>기타안내</h3>
					...
					사용 가능 최대금액)은 '한도제한없음' 입니다.<br> <br> <b>소멸조건</b><br>
